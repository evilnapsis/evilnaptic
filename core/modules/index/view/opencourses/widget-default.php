...
<div class="list-group">
  ...
  <a href="index.php?view=home" class="list-group-item"><i class="fa fa-dashboard"></i> Inicio</a>
...
<?php foreach(CourseData::getAll() as $c):?>
<h3><a href="index.php?view=admincourse&course_id=<?php echo $c->id; ?>"><?php if($c->is_public){ echo "<i class='fa fa-check-circle-o tip' title='Publico'></i>"; }?> <?php echo $c->name; ?></a></h3>
